	...
	<>
		<svg
			...
			<g>
				...
				<circle cx={50} cy={50} r={32.771} stroke='#000' fill='none' strokeDasharray='0 300'>
					<animate
						attributeName='stroke-dasharray'
				...
				<circle cx={50} cy={50} r={47.171} stroke='#000' fill='none' strokeDasharray='0 300'>
					<animate
						attributeName='stroke-dasharray'
		...
		<span className='text-black text-center'>{props.title || 'Loading'}</span>
	</>
);
